...
#===============================================================
	...
	$arr_rs = selectGoodsProposalGoods($conn, $gpg_no);
	...
	$PROPOSAL_PRICE			= $arr_rs[0]["PROPOSAL_PRICE"];
...
<input type="hidden" name="mode" value="<?=$mode?>">
			...
			<table cellpadding="0" cellspacing="0" width="100%" class="colstable03" data-gpg_no="<?=$gpg_no?>">
				...
				<tr>
					<th>제안가(VAT포함)</th>
					<th class="line" data-column="PROPOSAL_PRICE">
				...
				<tr>
					<th>제안가(VAT포함)</th>
					<th class="line" colspan="3" data-column="PROPOSAL_PRICE">
						<span><?=$PROPOSAL_PRICE?></span>
						<input type="text" value="" placeholder="수정 내용 작성 후 꼭 엔터키를 눌러주세요"/>
					</th>
				</tr>
