		...
		if($print_type == "DETAIL_MIDDLE_SIZE"){
			...
			for($goodsIndex = 0;$goodsIndex < sizeof($arr_rs_goods);$goodsIndex++){
				...
				if($goodsIndex % 3 == 0){
					...
					//set sheet title
					$objPHPExcel->setActiveSheetIndex($p)->setTitle(iconv("EUC-KR", "UTF-8", (($goodsIndex / 3)+1)."번"));
					...
					//set row title
					$objPHPExcel->setActiveSheetIndex($p)->setCellValue("A1",iconv("EUC-KR", "UTF-8","구분"));
					$objPHPExcel->setActiveSheetIndex($p)->setCellValue("A2",iconv("EUC-KR", "UTF-8","이미지"));
					$objPHPExcel->setActiveSheetIndex($p)->setCellValue("A3",iconv("EUC-KR", "UTF-8","품명"));
					$objPHPExcel->setActiveSheetIndex($p)->setCellValue("A4",iconv("EUC-KR", "UTF-8","구성"));
					$objPHPExcel->setActiveSheetIndex($p)->setCellValue("A5",iconv("EUC-KR", "UTF-8","기프트넷\n단가"));
					$objPHPExcel->setActiveSheetIndex($p)->setCellValue("A6",iconv("EUC-KR", "UTF-8","제안가"));
					$objPHPExcel->setActiveSheetIndex($p)->setCellValue("A7",iconv("EUC-KR", "UTF-8","박스입수"));
				...
				$objPHPExcel->setActiveSheetIndex($p)->setCellValue($column."2",iconv("EUC-KR", "UTF-8","이미지"));
