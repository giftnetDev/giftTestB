...
#===============================================================
	...
	$arr_rs = listConfirmCpOrderList($conn, $p_confirm_ymd, $p_buy_cp_no, $use_tf, $del_tf, $search_field, $search_str);
...
<div id="popupwrap_stock">
	<h1>공급 업체 정산 상세 조회</h1>
	<div id="postsch_code">
		<h2>* 공급 업체 정산 항목을 조회 합니다.</h2>
				...
				<?
					...
					if (sizeof($arr_rs) > 0) {
						...
						for ($j = 0 ; $j < sizeof($arr_rs); $j++) {
							...
							$SUM_PRICE = ($BUY_PRICE * $QTY) + ($EXTRA_PRICE * $QTY) + $DELIVERY_PRICE;
