...
<?
# =============================================================================
# File Name    : pop_emart_complete.php
# Modlue       : 
# Writer       : Sungwook Min 
...
#====================================================================
	...
	#====================================================================
		$savedir1 = $g_physical_path."upload_data/temp_order_emart_complete";
	#====================================================================
		...
		$filename = '../../upload_data/temp_order_emart_complete/'.$file_nm; 
		...
		for ($i = 3 ; $i <= $maxRow ; $i++) {
			...
			$emart_delivery_code = trim($objWorksheet->getCell('F' . $i)->getValue()); //배송번호

			$emart_delivery_code		= iconv("UTF-8","EUC-KR",$emart_delivery_code);
			
			//echo $emart_delivery_code."<br/>";
			InsertOrderEmartComplete($conn, $file_nm, $emart_delivery_code, $s_adm_no);
...
<div id="popupwrap_file">
	<h1>이마트 출고 등록</h1>
	<div id="postsch">
		<h2>* 이마트 배송완료를 위한 출고리스트를 다운받아 등록 합니다.</h2>
		<div class="addr_inp">
			<table cellpadding="0" cellspacing="0" class="colstable02">
				...
				<tr>
					<th>완료 엑셀 다운로드</th>
					<td colspan="3" style="position:relative" class="line">
						<a href="javascript:js_emart_upload_excel();"><img src="../images/admin/btn_confirm.gif" alt="확인" /></a> 출고관리 / 업체출고관리 / 운송장번호 일괄등록
					</td>
				</tr>
				<? } ?>
			</table>
