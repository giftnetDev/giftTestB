...
#=====================================================================
	...
	if ($mode == "U") {
		...
		$result = updateOrderGoodsOption($conn, $order_goods_no, $goods_option_nm_01, $s_adm_no);
				...
				<?
					...
					if (sizeof($arr_rs) > 0) {
						...
						<tr>
							...
							<td class="filedown"><input type="text" name="goods_option_nm_01" value="<?=$option_str ?>" class="txt" style="width:90%"> &nbsp;</td>
						</tr>
