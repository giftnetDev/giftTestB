...
#=====================================================================
	...
	if ($mode == "U") {
		...
		$result = updateOrderGoodsDelivery($conn, $order_goods_no, $delivery_price, $reserve_no, $s_adm_no);
				...
				<?
					...
					if (sizeof($arr_rs) > 0) {
						...
						<tr>
							...
							<td class="filedown"><input type="text" name="delivery_price" value="<?=$DELIVERY_PRICE ?>" class="txt" style="width:90%" onkeyup="return isPhoneNumber(this)"> &nbsp;</td>
						</tr>
