...
<script language="javascript">
	...
	function js_write() {
		document.location.href = "download_write.php";
	}
...
?>
      ...
      <div id="mwidthwrap">
        ...
        <div class="category_choice">
					<?= makeSelectBoxOnChange($conn,"GOODS","con_cate_01","125","제품군선택","",$con_cate_01)?>&nbsp;
					
					<?= makeGoodsSelectBoxOnChange($conn,$con_cate_01,"con_cate_02","130","제품선택","",$con_cate_02)?>&nbsp;

					<?= makeSelectBoxOnChange($conn,"OS","con_cate_03","155","OS 선택","",$con_cate_03)?>&nbsp;
				</div>     
          ...
          <td><?= $REG_DATE ?></td>
					...
					<?
						...
						if (sizeof($arr_rs) > 0) {
							#$search_field		= trim($search_field);
							#$search_str			= trim($search_str);
							$strParam = $strParam."&nPageSize=".$nPageSize."&search_field=".$search_field."&search_str=".$search_str."&con_cate_01=".$con_cate_01."&con_cate_02=".$con_cate_02."&con_cate_03=".$con_cate_03;
				...
				<div class="bottom_search">
					<select name="search_field" style="width:84px;">
						...
						<option value="KEYWORD" <? if ($search_field == "KEYWORD") echo "selected"; ?> >키워드</option>
					</select>
