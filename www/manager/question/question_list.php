...
<script language="javascript">
	...
	function js_write() {
		document.location.href = "question_read.php";
	}
...
?>
      ...
      <div id="mwidthwrap">
        ...
        <div class="category_choice">
					<br />
					<?= makeSelectBoxOnChange($conn,"GOODS","con_cate_01","120","제품군 선택","",$con_cate_01)?>
					<?= makeSelectBoxOnChange($conn,"QUS","con_cate_02","120","구분 선택","",$con_cate_02)?>
				</div>     
        ...
        <tr> 
          <td><?= $rn ?></td>
          <td><?= getDcodeName($conn, 'GOODS', $CATE_01) ?></td>
          <td><?= getDcodeName($conn, 'QUS', $CATE_02) ?></td>
