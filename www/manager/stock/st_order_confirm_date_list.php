		...
		<td class="contentarea">
			...
			<div id="mwidthwrap">
				...
				<thead>
						<th>공급업체</th>
						<td colspan="4">
							<?= makeCompanySelectBoxOnChabge($conn, '구매', $cp_type);?>&nbsp;&nbsp;&nbsp;<span id="ad_type_display"></span>
						</td>
					</tr>
				</thead>
				<tbody>
					<tr>
						...
						<td>
							<select name="order_field" style="width:84px;">
								...
								<option value="ALL_BUY_PRICE" <? if ($order_field == "ALL_BUY_PRICE") echo "selected"; ?> >총매입가</option>
							</select>&nbsp;&nbsp;
