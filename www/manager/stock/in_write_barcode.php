...
# Confirm right
#==============================================================================
	$menu_right = "SG015"; // 메뉴마다 셋팅 해 주어야 합니다
		...
		<td class="contentarea">
			...
			<div id="mwidthwrap">
				<div class="title_with_submenu">
					<h2 class="title">입고 등록 - 바코드</h2>  
					<div class="right_menu">	
						<b>출고등록으로</b>
						<span name="kancode_toOutStock"></span>
						<script>
							$(function(){
								$("span[name=kancode_toOutStock]").barcode("OUTSTOCK", "code128", {output:'bmp', barHeight:30});  
							});
						</script>
						 OUTSTOCK
					</div>
				...
				<tr>
					<th>송장번호</th>
					<td class="line">
						<input type="Text" name="delivery_no" value="<?=$delivery_no?>"  class="txt">
					</td>
					<th>입력 바코드</th>
					<td class="line">
						<input type="Text" name="barcode" value="" class="txt">
					</td>
				</tr>
				<tr>
					<th>화면 초기화</th>
					...
					$(function(){
						...
						$("input[name=delivery_no]").keydown(function(event){
							if(event.keyCode == 13)
							{
								...
								} else if($(this).val() == "OUTSTOCK")
								{
									location.href = "/manager/stock/out_write_barcode.php";
