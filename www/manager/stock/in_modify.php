...
#====================================================================
	...
	if ($mode == "U") {
		...
		$stock_code_name = getDcodeName($conn,"IN_ST",$stock_code);
				...
				<tbody>
					<tr>
						...
						<td style="position:relative" class="line">
							<?= makeSelectBoxAsName($conn, 'IN_ST','stock_code',"125", "선택", "", $rs_stock_code);?>
						</td>
						<th>입고업체</th>
						<td style="position:relative" class="line">
							<?=makeCompanySelectBoxWithName($conn, 'cp_type', '구매', $rs_cp_no)?>
						</td>
					</tr>
					<tr>
						<th>입고수량</th>
					...
					<tr>
						...
						<th>결제일</th>
						<td style="position:relative" class="line">
							<input type="Text" name="pay_date" value="<?= left($rs_pay_date,10)?>" style="width:100px; margin-right:3px;" itemname="결제일" required class="txt datepicker">
						</td>
