...
#===============================================================
	...
	$sheetIndex ->setCellValue("A$k", iconv("EUC-KR", "UTF-8","업체명(귀사)"))
				->setCellValue("B$k", iconv("EUC-KR", "UTF-8","주문번호"))   
				->setCellValue("C$k", iconv("EUC-KR", "UTF-8","비고"))   
				->setCellValue("D$k", iconv("EUC-KR", "UTF-8","비고(특이사항)"))   
				->setCellValue("E$k", iconv("EUC-KR", "UTF-8","수취인"))   
				->setCellValue("F$k", iconv("EUC-KR", "UTF-8","주소"))
				->setCellValue("G$k", iconv("EUC-KR", "UTF-8","전화번호1"))
				->setCellValue("H$k", iconv("EUC-KR", "UTF-8","전화번호2"))
				->setCellValue("I$k", iconv("EUC-KR", "UTF-8","상품명"))
				->setCellValue("J$k", iconv("EUC-KR", "UTF-8","수량"))
				->setCellValue("K$k", iconv("EUC-KR", "UTF-8","배송메세지"))
				->setCellValue("L$k", iconv("EUC-KR", "UTF-8","공급가"))
				->setCellValue("M$k", iconv("EUC-KR", "UTF-8","박스타입"));				


	//$sheetIndex->getRowDimension($k)->setRowHeight(30);

	$sheetIndex->getStyle("A$k:M$k")->getFont()->setSize(10)->setBold(true);
	$sheetIndex->getStyle("A$k:M$k")->getAlignment()
	->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER)->setVertical(PHPExcel_Style_Alignment::VERTICAL_CENTER);
	$sheetIndex->getStyle("A$k:M$k")->applyFromArray($listTitleStyle_left);
	$k += 1;
			...
			if(sizeof($arr_rs_individual) > 0) { 
				for($o = 0; $o < sizeof($arr_rs_individual); $o ++) { 
					...
					$objPHPExcel->setActiveSheetIndex(0)
						->setCellValue("A$k", iconv("EUC-KR", "UTF-8",$MEMO3))
						->setCellValue("E$k", iconv("EUC-KR", "UTF-8",$R_MEM_NM))
						->setCellValue("F$k", iconv("EUC-KR", "UTF-8",$R_ADDR1))
						->setCellValue("G$k", iconv("EUC-KR", "UTF-8",$R_PHONE))
						->setCellValue("H$k", iconv("EUC-KR", "UTF-8",$R_HPHONE))
						->setCellValue("I$k", iconv("EUC-KR", "UTF-8",$GOODS_NAME." ".$GOODS_SUB_NAME))
						->setCellValue("J$k", iconv("EUC-KR", "UTF-8",number_format($SUB_QTY)))
						->setCellValue("K$k", iconv("EUC-KR", "UTF-8",$MEMO))
						->setCellValue("L$k", iconv("EUC-KR", "UTF-8",number_format($BUY_PRICE)));

					$sheetIndex->getStyle("A$k:M$k")->getFont()->setSize(9);
					$sheetIndex->getStyle("A$k:M$k")->getAlignment()->setWrapText(true);
					$sheetIndex->getStyle("A$k:M$k")->getAlignment()->setVertical(PHPExcel_Style_Alignment::VERTICAL_CENTER);
					//$sheetIndex->getRowDimension($k)->setRowHeight(30);
				...
				$objPHPExcel->setActiveSheetIndex(0)
					...
					->setCellValue("F$k", iconv("EUC-KR", "UTF-8",$RECEIVER_ADDR))
					->setCellValue("G$k", iconv("EUC-KR", "UTF-8",$RECEIVER_PHONE))
					->setCellValue("H$k", iconv("EUC-KR", "UTF-8",$RECEIVER_HPHONE))
					->setCellValue("I$k", iconv("EUC-KR", "UTF-8",$GOODS_NAME." ".$GOODS_SUB_NAME))
					->setCellValue("J$k", iconv("EUC-KR", "UTF-8",number_format($REQ_QTY)))
					->setCellValue("K$k", iconv("EUC-KR", "UTF-8",$MEMO1))
					->setCellValue("L$k", iconv("EUC-KR", "UTF-8",number_format($BUY_PRICE)));
	...
	$objPHPExcel->getActiveSheet()->getStyle("A1:M".$k)->applyFromArray($BStyle);

	$margin = 0.45;
	$sheetIndex->getColumnDimension("A")->setWidth(20 + $margin);
	$sheetIndex->getColumnDimension("B")->setWidth(15 + $margin);
	$sheetIndex->getColumnDimension("C")->setWidth(10 + $margin);
	$sheetIndex->getColumnDimension("D")->setWidth(20 + $margin);
	$sheetIndex->getColumnDimension("E")->setWidth(15 + $margin);
	$sheetIndex->getColumnDimension("F")->setWidth(35 + $margin);
	$sheetIndex->getColumnDimension("G")->setWidth(15.71 + $margin);
	$sheetIndex->getColumnDimension("H")->setWidth(14.43 + $margin);
	$sheetIndex->getColumnDimension("I")->setWidth(35 + $margin);
	$sheetIndex->getColumnDimension("J")->setWidth(10 + $margin);
	$sheetIndex->getColumnDimension("K")->setWidth(35 + $margin);
	$sheetIndex->getColumnDimension("L")->setWidth(13 + $margin);
	$sheetIndex->getColumnDimension("M")->setWidth(13 + $margin);
	
	// Rename sheet
	$objPHPExcel->setActiveSheetIndex(0)->setTitle(iconv("EUC-KR", "UTF-8","제스파 발주서"));
