...
#====================================================================
	...
	$file_name="출고 상품 리스트-".date("Ymd").".xls";
...
<TABLE border=1>
	...
	<?
		...
		if (sizeof($arr_rs) > 0) {
			...
			for ($j = 0 ; $j < sizeof($arr_rs); $j++) {
				...
				$RS_PRICE		= trim($goods_rs[0]["SALE_PRICE"]); 
	...
	<tr>
		...
		<td bgColor='#FFFFFF' align='center'>정상출고</td>
		<td bgColor='#FFFFFF' align='center'></td>
		<td bgColor='#FFFFFF' align='right'></td>
		<td bgColor='#FFFFFF' align='right'><?=$RS_PRICE?></td>
		<td bgColor='#FFFFFF' align='left'>LG</td>
