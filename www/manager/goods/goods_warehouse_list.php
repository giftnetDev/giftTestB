...
# =============================================================================
# File Name    : goods_list_warehouse.php
# Writer       : KBJ
# Create Date  : 20210527 
# Memo		   : 창고전용 상품관리 화면 (기존 상품관리 화면 참조_202106 메뉴 개편) 
# Modify Date  :
# =============================================================================
...
# Confirm right
#==============================================================================
	$menu_right = "GD022"; // 메뉴마다 셋팅 해 주어야 합니다
			...
			<div class="sp20"></div>
				...
				?>
						<tr class="<?=$str_use_style?> <?=$str_wrong_style?>" >
							...
							<td><?=$GOODS_CODE?></td>
							<td class="modeual_nm"><?=$STR_TAX_TF?> <?= $GOODS_NAME ?> <?= $GOODS_SUB_NAME ?></a></td>
							<td class="modeual_nm"><?= getCompanyName($conn, $CATE_03);?></a></td>
							<td class="price">
