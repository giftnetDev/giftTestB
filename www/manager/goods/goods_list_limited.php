...
# Confirm right
#==============================================================================
	$menu_right = "GD020"; // 메뉴마다 셋팅 해 주어야 합니다
...
<script>
  ...
  <script type="text/javascript" >
	...
	function js_write() {
		document.location.href = "goods_write_limited.php";
	}
	...
	function js_view(rn, goods_no) {
		...
		frm.target = "";
		frm.method = "get";
		frm.action = "goods_write_limited.php";
		frm.submit();
