...
# Confirm right
#==============================================================================
	$menu_right = "S0009"; // 메뉴마다 셋팅 해 주어야 합니다
				...
				<?
					...
					if (sizeof($arr_rs) > 0) {
						for ($j = 0 ; $j < sizeof($arr_rs); $j++) {
							...
							$datediff=date_diff(date("Y-m-d H:i:s"), $arr_rs[$j]["REG_DATE"]);
						...
						<tr>
							<td class="font"><?= $rn ?></td>
							<td class="lpd10">
								<a href="javascript:js_view('<?=$rn?>','<?=$BB_CODE?>','<?=$BB_NO?>');"><?=$TITLE?></a>
								<?if($datediff<7){?>
								<img src="/kor/images/new.gif" width="33" height="11" align="absmiddle">
								<?}?>
							</td>
							<td><?=$WRITER_NM?></td>
