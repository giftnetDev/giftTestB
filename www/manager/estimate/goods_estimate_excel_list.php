...
#====================================================================
	...
	$arr_rs = listGoodsEstimate($conn, $start_date, $end_date, $cp_type, $del_tf, $search_field, $search_str, $order_field, $order_str, $nPage, $nPageSize, $nListCnt);
...
<TABLE border=1>
	...
	?>
			...
			<tr height="30">
				...
				<td bgColor='#FFFFFF' align='left'><b><?= number_format($ESTIMATE_PRICE)?></b></td>
