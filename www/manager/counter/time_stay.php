...
?>
	...
	<tr>
			...
			<table border="0" cellpadding="2" cellspacing="2" width="100%">
				<tr>
					<td class="lpd10">
						<b>시간대별 이용자 수 통계</b> (<?=$year?> 년 <?=$month?>월의 접속 통계)
					</td>
				</tr>
				<tr>
					<td class="lpd10">
...
echo "  <TABLE width='100%' cellpadding='0' cellspacing='0' border='0' bordercolorlight='#666666' bordercolordark='#FFFFFF' bgcolor='#FFFFFF' bordercolor='#FFFFFF'>
    <tr> 
...
for($i=0;$i<=11;$i++) {
	...
	$r = mysql_query("SELECT COUNT(*) FROM TBL_TOTAL_COUNTER WHERE SITE_CODE = '$site_code' AND YEAR='$year' AND MONTH='$month' AND TIME='$i'");
...
echo " 
      <td width='310' height='158' valign='top'> 
        <table border=0 cellpadding=2 cellspacing=2 width=100%>
	<tr>
		<td align=center bgcolor='#F6F6F6' width='30'>
			시간
