...
$max_result = mysql_query("SELECT DAY, COUNT(*) MAX FROM TBL_COUNTER WHERE SITE_CODE = '$site_code' AND YEAR='$year' AND MONTH='$month' GROUP BY  DAY ORDER BY MAX DESC,DAY DESC LIMIT 1");
echo mysql_error();
...
$min_result = mysql_query("SELECT DAY,COUNT(*) MAX FROM TBL_COUNTER WHERE SITE_CODE = '$site_code' AND YEAR='$year' AND MONTH='$month' GROUP BY DAY ORDER BY MAX,DAY DESC LIMIT 1");
...
$result = mysql_query("SELECT COUNT(*) FROM TBL_COUNTER WHERE SITE_CODE = '$site_code' AND YEAR='$year' AND MONTH='$month'");
...
for($i=1;$i<=15;$i++) {
	...
	$r = mysql_query("SELECT COUNT(*) FROM TBL_COUNTER WHERE SITE_CODE = '$site_code' AND YEAR='$year' AND MONTH='$month' AND DAY='$i'");
...
<?
	...
	for($i=01;$i<=12;$i++) {
		...
		$q = "SELECT * FROM TBL_COUNTER WHERE SITE_CODE = '$site_code' AND YEAR=$year AND MONTH=$i";
