...
#====================================================================
	...
	if ($mode == "U") {
		$result = updateOptMemo($conn, $order_goods_no, $opt_memo);
		mysql_close($conn);
...
<?
	...
	$OPT_MEMO	= trim($arr_rs[0]["OPT_MEMO"]);
...
<div id="popupwrap_file">
	<h1>작업 메모</h1>
	<div id="postsch_code">
		<h2>* 작업 메모 입니다. 등록을 클릭하면 해당 내용이 저장 됩니다.</h2>
		<div class="addr_inp">
						...
						<colgroup>
							...
							<tr>
								<td colspan="3" class="lpd20 rpd20 right">
									<textarea name="opt_memo" class="txt" style="width:100%" rows="15"><?=$OPT_MEMO ?></textarea>
								</td>
							</tr>
					</table>
				</td>
