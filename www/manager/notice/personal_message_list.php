...
#===============================================================
	...
	*/
	...
	if ($s_adm_group_no == "1") { 
		...
		$nListCnt =totalCntBoardMessage($conn, $bb_code, $con_cate_01, $con_cate_02, $con_cate_03, $con_cate_04, $s_adm_no, $keyword, $reply_state, $con_use_tf, $del_tf, $search_field, $search_str);
		...
		$arr_rs = listBoardMessage($conn, $bb_code, $con_cate_01, $con_cate_02, $con_cate_03, $con_cate_04, $s_adm_no, $keyword, $reply_state, $con_use_tf, $del_tf, $search_field, $search_str, $nPage, $nPageSize);
	}
...
<script language="javascript">
	...
	function js_write() {
		document.location.href = "personal_message_write.php";
	}
	...
	function js_view(rn, bb_code, bb_no) {
		...
		frm.target = "";
		frm.method = "get";
		frm.action = "personal_message_read.php";
		frm.submit();
