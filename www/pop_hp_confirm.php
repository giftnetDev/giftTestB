...
<body>
    ...
    <h5 class="title"><span id="spanIdpw">휴대폰 인증</span></h5>
    <div class="contents">
        ...
        <!--SMS용-->
          ...
          <div class="form-group" id="divcerSend"> 
            <div class="col-sm-offset-2 col-sm-10 col-lg-9 col-lg-offset-3" style="text-align:center;">
              <button type="button" name="cerNm" id="cerNm" class="btn btn-default" onclick="fn_certificationNm();">인증번호전송</button>
            </div>
          </div>

          <div class="form-group" id="divcerconfirm" >           
