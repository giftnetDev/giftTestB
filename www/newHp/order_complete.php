                ...
                <div class="detail_page_inner">
                    <div class="cart_info">
                        ...
                        <div class="cong">      
                            ...
                            주문번호 : <?=$reserveno ?><br>배송조회를 통해 주문한 제품을 확인하세요.
                        </div><!--cong-->
                        <br>
                        <br>
                        <div class="tcenter margin-top-10"> 
                            <button class="carting" onclick="js_move_page('delivery_confirm.php');">주문/배송</button>
                            <button class="joomoon" onclick="js_move_page('Nindex.php');">메인으로 가기</button>
