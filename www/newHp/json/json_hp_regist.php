...
function insertHpMemeber($db, $custTp, $custID, $custPwd, $custNm, $custEmail, $custTelPhone, $custPhone, $custZipcode, $custAddr, $custAddr2, $bizNo1, $bizNo2, $bizNo3, $companyNm, $ceoNm, $cpNo)
{
...
function Update_CustomerInfo($db, $custNo, $custTp, $custID, $custPwd, $custNm, $custEmail, $custTelPhone, $custPhone, $custZipcode, $custAddr, $custAddr2, $bizNo1, $bizNo2, $bizNo3, $companyNm, $ceoNm, $cpNo)
{
...
{			
	...
	$NcustAddr2		= iconv("utf8","euckr",$custAddr2);
	...
	if(insertHpMemeber($conn, $custTp, $custID, $custPwd, $NcustNm, $custEmail, $custTelPhone, $custPhone, $custZipcode, $NcustAddr, $NcustAddr2, $bizNo1, $bizNo2, $bizNo3, $NcompanyNm, $NceoNm, $cpNo) == 1 )
	{
...
if($mode=="HOMEPAGE_MYINFO_SEL")
{
	...
	if(sizeof($arr) > 0) 
	{
		...
		$ADDR2 		= iconv("euckr","utf8", $arr[0]["ADDR2"]);
		$PHONE1 	= $arr[0]["PHONE1"];
		$PHONE2 	= $arr[0]["PHONE2"];
		$PHONE3 	= $arr[0]["PHONE3"];
...
if($mode=="HOMEPAGE_CUSTOMER_UP")
{
	...
	if(Update_CustomerInfo($conn, $custNo, $custTp, $custID, $custPwd, $NcustNm, $custEmail, $custTelPhone, $custPhone, $custZipcode, $NcustAddr, $NcustAddr2, $bizNo1, $bizNo2, $bizNo3, $NcompanyNm, $NceoNm, $cpNo) == 1 )
	{
		$result = "Y";
		echo "[{\"RESULT\":\"".$result."\"}]";
	}
