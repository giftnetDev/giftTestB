			...
			<div class="detail_page">
				<div class="detail_page_order2">
						...
						<div class="order_list">
							<b><?=$orderInfos[0]["REG_DATE"]?> 주문 <br>주문번호 <?=$orderInfos[0]["RESERVE_NO"]?></b>
							<?
								if($cnt>0){
									$FINAL_AMOUNT = 0;
									$DELIVERY_TOT = 0;
									...
									?>
										<div class="order_box">
											<table>
												<tr>
													<td rowspan="3">
														...
														<?
															...
															{
														?>
																<br><div class="button_order_rel_01" onclick="js_delivery_pop('<?=$DELIVERY_CP?>','<?=$DELIVERY_NO?>')">배송조회</div>														
														<?
															}
														?>
													</td>
												...
												<tr>
													<td style="width: 25%; text-align: center;"><?=number_format($orderInfos[$i]["QTY"])?>개</td>
													<td style="width: 30%; text-align: center;"><?=number_format($orderInfos[$i]["SALE_PRICE"])?>원</td>
													<td style="width: 45%; text-align: center;">총 <?=number_format($TOTAL_PRICE)?>원</td>
												</tr>
											</table>	
										</div>
									<?
							...
							<div class="join_btn">
								<button class="cancel" onclick="js_joomonList();">주문목록</button>
								<button class="next" style="margin-left: 10px;" onclick="js_joomoonDel('<?=$reserveNo?>')">주문삭제</button>
							</div>
						</div><!--order_list-->
				</div>
			</div><!--detail_page-->
