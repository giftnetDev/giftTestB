...
<div class="wrap_id_pw">
    <div>
        <span id="spanIdpw"><b>아이디/비밀번호 찾기</b></span><br>
            ...
            <div id="dividpw" class="trightidpw"> 
                <div>
                <a href="javascript:fn_idpwFind()" name="idpw" id="idpw" class="cartingidpw" >ID/PW 찾기</a>
                </div>
            </div>
            ...
            <div id="divcer" >           
                ...
                <button type="button" name="certifi" id="certifi" onclick="js_cerConfirm();" style="width:100px; float: right;">인증번호확인</button>
                </div>
            </div>
            ...
            <div id="divcust" style="display: block;">
                ...
                <span>새로운 비밀번호</sapn>
                <input type="password" name="custNpw" id="custNpw" style="width:300px;display:inline; margin-bottom: 30px;;" maxlength=10 placeholder="숫자+영문자+특수문자 조합으로 6~12자리">

                <sapn>비밀번호 확인</sapn>
                <input type="password" name="custNpwcf" id="custNpwcf" style="width:300px;display:inline; margin-bottom: 30px;;" maxlength=10 placeholder="숫자+영문자+특수문자 조합으로 6~12자리">

                <div class="trightidpw" style="text-align:center;">
                <a href="javascript:js_pwUpConfirm()" name="custpwOk" id="custpwOk" class="cartingidpw" >확인</a>
                </div>
