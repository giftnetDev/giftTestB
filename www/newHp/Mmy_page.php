            ...
            <h3>마이페이지</h3>
                <div class="process">      
                    ...
                    <div class="form-group regist" style="border-top: 0px !important; text-align: right;">
                        <button type="button" onclick="js_member_pwck();" style="cursor:pointer;width:65px;height:30px;background:gray;color:white;border:none;vertical-align:middle;" id="member_del">회원탈퇴</button>
                    </div>

                    <div class="join_btn">
                        <a href="Mindex.php" class="cancel">홈으로</a>&nbsp;&nbsp;
                        <button type="button" class="next" onclick="fn_update()">수정</button>
                    </div>
