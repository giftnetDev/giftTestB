...
function js_pwUpSetting()
{
    ...
    document.getElementById("spanIdpw").innerHTML = "<b>비밀번호 설정</b>";
...
<body class="id_pw_body">
<div class="wrap_id_pw">
<div>
<span id="spanIdpw"><b>아이디/비밀번호 찾기</b></span>
        ...
        <input type="hidden" name="testflag" value="">  <!--값이 없으면 문자날라감. 값이 Y면 문자정송 안됨-->
        ...
        <!--SMS용-->
          ...
          <div id="divhpnm">
            <span>고객명</span>
            <div>
              <input type="text" name="hpnm" id="hpnm" style="width:340px;display:inline;" maxlength=10>
            </div>
          </div>

          <div id="divphone">
            <span id="phone">휴대폰번호</span>
            <div> 
              <input type="number" class="form-control" name="phone1" id="phone1" style="width:104px;display:inline;" max="9999" maxlength="3" oninput="maxLengthCheck(this)"> -
              <input type="number" class="form-control" name="phone2" id="phone2" style="width:104px;display:inline;" max="9999" maxlength="4" oninput="maxLengthCheck(this)"> -
              <input type="number" class="form-control" name="phone3" id="phone3" style="width:104px;display:inline;" max="9999" maxlength="4" oninput="maxLengthCheck(this)">
            </div>
          </div>

          <div id="dividpw" class="tright"> 
            <div>
              <a href="javascript:fn_idpwFind()" name="idpw" id="idpw" class="carting  margin-top-10" >ID/PW 찾기</a>
            </div>
          </div>
          ...
          <div id="divcer" >           
            <div>
            <span>인증번호</span>
            <input type="number" class="ij" name="cerbox" id="cerbox" style="width:125px;display:inline; justify-content: left; align-items: left; text-align: center;" max="9999" maxlength="6" oninput="maxLengthCheck(this)" >  
            &nbsp;&nbsp;&nbsp;<div id = "divtimer" style="width:300px;display:inline; text-align: center; color: blue;"></div>&nbsp;&nbsp;&nbsp;
            <button type="button" name="certifi" id="certifi" onclick="js_cerConfirm();" style="width:120px;">인증번호확인</button>
            </div>
          </div>
          ...
          <div id="divcust" style="display: block;">
            ...
            <span>고객 ID</span>
              <input type="text" name="custId" id="custId" style="width:340px;display:inline; margin:0;" maxlength=10 readonly>

            <span>새로운 비밀번호</sapn>
              <input type="password" name="custNpw" id="custNpw" style="width:340px;display:inline; margin:0;" maxlength=10 placeholder="숫자+영문자+특수문자 조합으로 6~12자리">

            <sapn>비밀번호 확인</sapn>
              <input type="password" name="custNpwcf" id="custNpwcf" style="width:340px;display:inline; margin:0;" maxlength=10 placeholder="숫자+영문자+특수문자 조합으로 6~12자리">

            <div class="tright" style="text-align:center;">
              <a href="javascript:js_pwUpConfirm()" name="custpwOk" id="custpwOk" class="carting  margin-top-10" >확인</a>
            </div>
