...
<html lang="ko">
    <head>
        ...
        <script>
            ...
            function js_open_claim_window(orderGoodsNo){
                $.ajax({
                    ...
                    success:function(goodsInfo){
                        ...
                        $("#goods_totprice").html(js_add_comma(goodsInfo["SALE_PRICE"]*goodsInfo["QTY"]));
                        $("#opt_comment").html(goodsInfo["OPTION_COMMENT"]);
            ...
            function js_viewOrderGoodsByReserveNo(reserveNo){
                ...
                frm.sel_reserve_no.value=reserveNo;
                frm.method="POST";
                frm.action="Mdelivery_detail.php";
                frm.submit();
            ...
            function js_open_detail_window(orderGoodsNo){
                ...
                $.ajax({
                    ...
                    success:function(goodsInfo){
                        ...
                        $("#goods_name_c").html(goodsInfo["GOODS_NAME"]);

                        $("#goods_name2_c").html("["+goodsInfo["GOODS_CODE"]+"]"+goodsInfo["GOODS_NAME"]+" "+goodsInfo["GOODS_SUB_NAME"]);

                        $("#goods_totprice_c").html(js_add_comma(goodsInfo["SALE_PRICE"]*goodsInfo["QTY"]));
                        $("#opt_comment_c").html(goodsInfo["OPTION_COMMENT"]);
            ...
            function js_delivery_pop(delivery_cd, delivery_no)
            {
                ...
                window.open(url, "Mpop_delivery_trace", "width=auto, height=auto");
            }
            function js_cancel(){
                $("#claim_popup").css("display","none");
    ...
    <body>
        <div class="detail_page">
            ...
            <div class="detail_page_order" style=" position: fixed; z-index: 1;">	
                        <h3>
                            주문/배송 조회
                        </h3>
                        <div class="processing">
                            ...
                            ?>
                            <img src="img/process_mobile.png" alt="">                            
                        </div>

                        <div class="processing_tp">
                        <span><font color="black"> 주문접수</font> <?=$arrOrderState[0]["CNT"]<>""? $arrOrderState[0]["CNT"]:0?></span>
                        <span><font color="black"> 작업중</font> <?=$arrOrderState[1]["CNT"]<>""? $arrOrderState[1]["CNT"]:0?></span> 
                        <span><font color="black"> 배송중</font> <?=$arrOrderState[2]["CNT"]<>""? $arrOrderState[2]["CNT"]:0?></span> 
                        <span><font color="black"> 배송완료</font> <?=$arrOrderState[3]["CNT"]<>""?$arrOrderState[3]["CNT"]:0?></span> 
                        </div>
                            ...
                            <div class="navbar navbar-default">
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="navbar-form navbar-left">
                                        ...
                                        <input type="text" class="form-control" style="width:96px" name="search_str" placeholder="검색어 입력" value="<?=$search_str?>">
            ...
            <div class="detail_page_order2" style="padding-left: 20px; padding-right: 20px; background: white;">	
                        ...
                        <?
                            ...
                            ?>
                                            ...
                                            <tr>
                                                <td rowspan="3">
                                                <dl style="cursor: pointer;" onclick="location.href='Mgoods_info.php?goods_no=<?=$arrOrderGoods[$i]['GOODS_NO']?>'">
                                                    <div class="thumb" style="background:url('<?=$orderGoodsImgUrl?>') no-repeat;background-size:cover;">
                                                    </div>
                                                </dl>
                                                    <!--<dl style="cursor: pointer;" onclick="location.href='Mgoods_info.php?goods_no=<?=$arrOrderGoods[$i]['GOODS_NO']?>'">
                                                        <div class="thumb" style="background:url('<?=$orderGoodsImgUrl?>') no-repeat;background-size:auto 100%; background-position:center center">
                                                        </div>
                                                    </dl>-->
                                                </td>
                                            ...
                                            <tr>
                                                <td><?=$arrOrderGoods[$i]["QTY"]?>개</td>
                                                <td style="text-align:right !important"><?=number_format($arrOrderGoods[$i]["SALE_PRICE"])?>원</td>
                                                <td <?=$backgroundColor?>><?=$orderStateStr?></td>
                                            </tr>
                                            <tr>
                                                <td colspan="3">
                                                <?
                                                    ...
                                                    {
                                                ?>
                                                        <button onclick="js_delivery_pop('<?=$DELIVERY_CP?>','<?=$DELIVERY_NO?>')">배송조회</button>
                                                <?
                                                    }
                                                    else
                                                    {
                                                ...
                                                <?
                                                    ...
                                                    ?>
                                                        <button class="red" type="button" onclick="js_open_detail_window('<?=$arrOrderGoods[$i]['ORDER_GOODS_NO']?>')">상세보기</button>
                                                    <?
                                                    }
                                                    ...
                                                    ?>
                                                        <button class="red" type="button" onclick="js_open_claim_window('<?=$arrOrderGoods[$i]['ORDER_GOODS_NO']?>')">교환/반품</button>
                                                    <?
                                                    }
                                                ?>
                        ...
                        ?>
                            <form name="pageForm" method="POST">
                                <div class="bottom_section" style="margin-top: 20px;">
        ...
        <div class="claim_pop">
            ...
            <div class="claim_pop_x">X</div>                
                <form name="frmClaim" method="POST">
                    <div class="order_dt" style="overflow-y: auto !important; height: 530px;">
                        <div class="order_box1">
                            <table>
                                <tr>
                                    <td rowspan="3">
                                        <div class="product_pic" id="goods_image" style="background:url('') no-repeat; background-size:cover; background-position:center center;"></div>
                                    </td>
                                        
                                    <td colspan="3">
                                        <span id="goods_name"></span> 
                                        <br>
                                        <span id="opt_comment" style="color: #518d60;"></span> 
                                    </td>
                                    <input type="hidden" name="cartNo[]" value="">
                                </tr>
                                <tr>
                                    <td style="width: 25%; text-align: center;"><span class="span_num_format" id="goods_quantity"></span> 개</td>      <!--수량-->
                                    <td style="width: 30%; text-align: center;"><span class="span_num_format" id="goods_price"></span> 원</td>    <!--상품가격-->               
                                    <td style="width: 45%; text-align: center;">총 <span class="span_num_format" id="goods_totprice"></span> 원</td>    <!--총가격-->               
                                </tr>
                            </table>
                        </div>
                        <br>
                        <div class="data_zone">
                            <table class="claim">
                                ...
                                <tr>
                                    <th>메모</th>
                                    <td colspan="3" ><textarea id = "claim_memo" name="claim_memo" maxlength="200" wrap="hard" style="margin: 5px; width: 90%; height: 50px; margin:auto; white-space: pre-wrap; border: 1px solid #d4d4d4; "></textarea></td>
                                </tr>
                        ...
                        <div class="join_btn">
                            <button type="button" class="cancel" onclick="js_cancel();">취소</button>
                            <button type="button" class='next' style="margin-left: 10px;" onclick="js_claim();">신청</button>
                ...
                <div class="order_dt">
                    <div class="order_box1">
                        <table>
                            <tr>
                                <td rowspan="3">
                                    <div class="product_pic" id="goods_image_c" style="background:url('') no-repeat; background-size:cover; background-position:center center;"></div>
                                </td>
                                    
                                <td colspan="3">
                                    <span id="goods_name_c"></span> 
                                    <br>
                                    <span id="opt_comment_c" style="color: #518d60;"></span> 
                                </td>
                                <input type="hidden" name="cartNo[]" value="">
                            </tr>
                            <tr>
                                <td style="width: 25%; text-align: center;"><span class="span_num_format" id="goods_quantity_c"></span> 개</td>      <!--수량-->
                                <td style="width: 30%; text-align: center;"><span class="span_num_format" id="goods_price_c"></span> 원</td>    <!--상품가격-->               
                                <td style="width: 45%; text-align: center;">총 <span class="span_num_format" id="goods_totprice_c"></span> 원</td>    <!--총가격-->               
                            </tr>
                        </table>
                    </div>
                    <br>
                    <div class="data_zone">
                        <div class="center_zone">
                            <span class="index" id="reg_date_type" style="font-weight: bold; color: black;"></span> : <span class="date" id="reg_date" style="font-weight: bold; color: black;"></span><br>
                            <span class="text" id="claim_info_msg"></span>
                        </div>
                    </div>

                    <div class="join_btn">
                        <button type="button" class="cancel" onclick="js_cancel();">닫기</button>
                    </div>
                </div>
        </div>
</div>
