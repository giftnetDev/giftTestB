                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style=" text-align: left; font-size: 12px;">
                                                    <!--<input type="text" style="width: 93%; height: 25px; border: 1px solid #d4d4d4;" value="농협은행 : 351-1137-6964-13 기프트넷" disabled><br>-->
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style=" text-align: left;">
                                                    <input type="text" style="width: 93%; height: 25px; border: 1px solid #d4d4d4; text-align: right;" value="<?=number_format($allTotalPrice)?>" disabled>
                                                    <font color="gray" style="font-size: 12px;">원</font>                                                    
                                                    <font color="gray" style="font-size: 12px; text-align: left;">카드 결제 하실 고객은 주문완료 후 고객센터를 통해 결제 하시기 바랍니다. 주문번호를 꼭 기억 해 주세요.</font>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
