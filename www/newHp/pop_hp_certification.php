...
function js_close()
{
    ...
    opener.document.getElementById("phone1").value = frm.phone1hd.value;
    opener.document.getElementById("phone2").value = frm.phone2hd.value;
    opener.document.getElementById("phone3").value = frm.phone3hd.value;
...
<body class="id_pw_body">
    ...
    <div>
        ...
        <input type="hidden" name="testflag" value=""><!--테스트일 경우 Y 아니면 공백으로 하면 문자날라간다-->
        ...
        <!--SMS용-->
          ...
          <div class="tright" id="divcerSend"> 
            <div>
              <a href="javascript:fn_certificationNm()" name="cerNm" id="cerNm" class="carting margin-top-10" >인증번호전송</a>
            </div>
          </div>
          ...
          <div id="divcerconfirm" >           
            <div>
            <span>인증번호</span>
            <input type="number" class="ij" name="cerbox" id="cerbox" style="width:42%;display:inline; text-align: center;" max="9999" maxlength="6" oninput="maxLengthCheck(this)" >  
            &nbsp;&nbsp;&nbsp;
            <div id = "divtimer" style="width:20%;display:inline; text-align: center; color: blue;"></div>&nbsp;&nbsp;&nbsp;
            <button type="button" name="certifi" id="certifi" style="width:31%;" onclick="js_cerConfirm();">인증번호확인</button>
            </div>
          </div>           
