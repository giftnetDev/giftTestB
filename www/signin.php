<?
	...
	*/
	...
	if($mode == "SIGNIN") { 
		...
		if($error_msg == "") { 
			$result = insertMember($conn, $mem_type, $mem_id, $mem_pw, $mem_nm, $jumin1, $jumin2, $biz_num1, $biz_num2, $biz_num3, $birth_date, $calendar, $email, $email_tf, $zipcode, $addr1, $addr2, $phone, $hphone, $job, $position, $cphone, $cfax, $czipcode, $caddr1, $caddr2, $join_how, $join_how_person, $join_how_etc, $etc, $foreigner_num, $use_tf, $reg_adm);	
    ...
    <div class="contents">
        <form name="frm" class="form-horizontal in-signin" method="post">
			...
			<div class="form-group">
				...
				<label class="control-label col-sm-3" for="addr1">수령지 주소</label>
                <div class="col-sm-10 col-lg-offset-0 col-lg-9">
