<?
    ...
    function getMemberProposal($db,$cp_no,$start_date,$end_date,$cate_cd,$cate_04,$search_option,$search_str){
        $query ="SELECT A.*, REPLACE(B.CATE_NAME,'단품 ','') AS CATE_NAME
    ...
    $arr_rs = getMemberProposal($conn,$rs_cp_no,$start_date,$end_date,$cate_cd,$cate_04,$search_option,$search_str);  
?>
...
<div class=" members signin" style="width:100%;padding-left:15px;padding-right:15px;">
    <h5 class="title">상품 관리</h5>
    <div class="contents">
        <form name="frm" class="form-horizontal in-signin" method="post">
            <input type="hidden" name="mode" value="">
            <ul class="nav nav-pills navbar-right">
                <li class=""><a href="/my_goods.php" style="padding:0;color:grey;">내 판매 상품</a></li>
    ...
    <div style="text-align:right; padding-bottom:10px;">
        ...
        <button type="button" id="delBtn" class="btn btn-default">선택삭제</button>
    </div>
        ...
        <table class="table table-hover border" style="background-color:#fff;width:100%;">
            <thead class="thead-light">
                <tr>
                    ...
                    <th scope="col" class="border" >승인여부</th>
            ...
            <tbody>
                ...
                ?>
                <tr>
                    <td scope="row"  class="border" ><input type="checkbox" id="chk_<?=$PROPOSAL_NO?>" value="<?=$PROPOSAL_NO?>" /></td>
                    <td scope="row"  class="item border" ><?=$ACPT_TF?></td>
                    <td scope="row"  class="item border" ><img src="<?=$NORMAL_FILE_NM?>" width="100px" height="100px" /></td>
                    ...
                    <?$temp_name_in_reason = explode(' ',$REASON);?>
                    <td scope="row"  class="item border" ><?=$temp_name_in_reason[0]?></td>
...
<script>
    $(document).ready(function(){
        ...
        $(".item").click(function(){
            //선택된 제안 상품의 제안번호
            var proposal_no = $(this).parents("tr").children("td:first").children("input").val();

            //이동할 주소
            var url = "https://www.giftnet.co.kr/member_goods_proposal.php?proposal_no="+proposal_no;
