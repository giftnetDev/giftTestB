            ...
            <h2>마이페이지</h2>
                ...
                <? } ?>                
                    ...
                    <div class="form-group regist rg_first" style="margin-top: 30px;">
                        <label class="control-label" for="iid">아이디</label>
                        <div class="col-sm-10" >
                    ...
                    <div class="form-group regist">
                        ...
                        <label class="control-label" for="rpwd">비밀번호 확인</label>
                            <div class="col-sm-10">
                    ...
                    <div class="form-group regist">
                        <label class="control-label" for="name">휴대전화</label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group regist">
                        ...
                        <label class="control-label">주&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;소</label>
                        <div class="col-sm-10">
