...
function jsHpck()
{
    ...
    NewWindow("pop_hp_certification.php", 'hp_certificationNm','420','300','YES');
}
            ...
            <h2>회원가입</h2>
                <div class="process">      
                    ...
                    <div class="form-group">
                        <label>▶ 이용 약관</label>
                        <div style="width:100%; height:300px; padding:10px; overflow:hidden; overflow-y:scroll; overflow-x:scroll; border: 1px solid #babdc8;overflow-x:hidden !important;">
                                <?
                                        $bb_no = 3;
                                        $bb_code = "HOMEPAGE";
                    ...
                    <div class="tcenter margin-top-10">
                        <a href="log-in.php" class="carting">취소</a>
                        <button class="joomoon btn_level1">다음</button>
                    </div>                    
            </div>     
        </div>    
    <!-------------------------------------------------------------약관동의 END----------------------------------------------------------------------->
                ...
                <div class="process">      
                    ...
                    <div class="form-group regist rg_first" style="margin-top: 30px;">
                        ...
                        <div class="col-sm-10" >
                            ...
                            &nbsp;<button type="button" id="id_dup" onclick="jsIdck();">ID중복체크</button>
                    ...
                    <div class="form-group regist">
                        ...
                        &nbsp;<button type="button" id="hpConfrim" onclick="jsHpck();">휴대폰인증</button>
                    ...
                    <label class="control-label" for="biz_num1">사업자 번호</label>
                        <div class="col-sm-10">
                            ...
                            <span style="color: gray;">&nbsp;&nbsp;기존 업체일 경우 검색 가능합니다.(검색 상이 시 고객센터로 문의해주세요.)</span>
                    ...
                    <div class="tcenter margin-top-10">
                        <a href="log-in.php" class="carting">취소</a>
                        <button type="button" class="joomoon" onclick="js_memeberIn()">회원가입</button>
                    </div>
        ...
        <div id="divlevel3">
            ...
            <div class="process">
                ...
                <div class="tcenter margin-top-10">
                    ...
                    <a href="log-in.php" class="joomoon">로그인</a>
                </div>
            </div>
        </div>    
<!-------------------------------------------------------------가입완료 END----------------------------------------------------------------------->
