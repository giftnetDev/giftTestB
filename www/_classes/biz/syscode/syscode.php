<?
	...
	*/
	...
	function renamePcodeOnDcode($db, $pcode, $pcode_no) {
		$query ="UPDATE TBL_CODE_DETAIL 
							SET PCODE =	'$pcode'
							WHERE PCODE IN (SELECT PCODE FROM TBL_CODE_PARENT WHERE PCODE_NO = '$pcode_no') ";
